...
class Mission:
    ...
    def from_csv(cls, file_name: str):
        ...
        reference = all_data['reference'].to_numpy()
        cave_height = all_data['cave_height'].to_numpy()
        cave_depth = all_data['cave_depth'].to_numpy()
        return cls(reference, cave_height, cave_depth)
...
class ClosedLoop:
    ...
    def simulate(self,  mission: Mission, disturbances: np.ndarray) -> Trajectory:
        ...
        for t in range(T):
            ...
            actions[t] = self.controller.update(observation_t, mission.reference[t], self.plant.dt)
